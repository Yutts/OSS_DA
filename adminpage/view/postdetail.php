             ...
             <div class="card" >
               ...
               <div class="card-title">
                 <ol class="breadcrumb text-right">
                      ...
                      <li class="active">/ &nbsp;Thông tin chi tiết bài viết</li>
                 </ol>
...
{       
            echo'<form action="../controller/postcontroller.php?id='.$bv["mabv"].'" method="post" enctype="multipart/form-data" class="form-horizontal">';
                                    ...
                                    echo'</div>';
                                     ...
                                     echo'<div class="row form-group">';
                                      echo' <div class="col col-md-3"><label for="inputDate">Ngày đăng</label></div>';
                                      echo' <div class="col-12 col-md-9"> <input type="date" name="txt_ngaydang" id="txt_ngaydang" maxlength="30" class="form-control" value="'.$bv["ngaydang"].'" required="" disabled autocomplete="off"></div>';
                                     echo'</div>';
                                     }
?>
                                </form>
