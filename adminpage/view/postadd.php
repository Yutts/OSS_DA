    ...
    <div class="container-fluid" style="float: left;">
      ...
      <div class="col-lg-12">
         <div class="card">
           ...
           <hr>
            <form action="../controller/postcontroller.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    
                                    
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="textarea-input" class=" form-control-label">Tiêu đề</label></div>
                                        <div class="col-12 col-md-9"><textarea name="txt_tenbv" id="txt_tenbv" rows="2" class="form-control"  required></textarea></div>
                                    </div>
                                    
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="textarea-input" class=" form-control-label">Nội dung</label></div>
                                        <div class="col-12 col-md-9"><textarea name="txt_noidung" id="txt_noidung" rows="9" class="form-control"  required></textarea></div>
                                    </div>
                                ...
                                <button type="submit" name="btn_post_group" value="create" class="btn btn-primary btn-sm">
