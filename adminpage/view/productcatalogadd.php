           ...
           <hr>
            <form action="../controller/produccatalogcontroller.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="txt_tendm" name="txt_tendm" class="form-control">
                                    </div>
                                  </div>

                                  <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Số lượng sản phẩm</label></div>
                                        <div class="col-12 col-md-9"><input type="number" id="txt_soluong" name="txt_soluong" class="form-control">
                                    </div>
                                  </div>
                                    
                       <div class="card-footer">
                                <button type="submit" name="btn_productcatalog_group" value="create" class="btn btn-primary btn-sm">
