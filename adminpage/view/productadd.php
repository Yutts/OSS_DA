...
<div class="clearfix"></div>
           ...
           <hr>
            <form action="../controller/productcontroller.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="txt_tensp" name="txt_tensp" class="form-control">
                                    </div>
                                    </div>
                                    
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="password-input" class=" form-control-label">Số lượng</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="txt_soluongsp" name="txt_soluongsp" class="form-control"></div>
                                    </div>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="txt_mau" name="txt_mau" class="form-control"></div>
                                    </div>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><textarea name="txt_mota" id="txt_mota" rows="9" class="form-control"></textarea></div>
                                    </div>
  ...
  while($row = $stmt->fetch() ){
                                ...
                                <button type="submit" name="btn_product_group" value="create" class="btn btn-primary btn-sm">
