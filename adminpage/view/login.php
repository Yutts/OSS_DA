		 ...
		 <div class="card-content p-2">
		  ...
		  <div class="card-title text-uppercase text-center py-3">Sign In</div>
			...
			<div class="form-row">
			 ...
			 <button type="submit" id="btn_login" name="btn_login" class="btn btn-light btn-block">Sign In</button>
  ...
  <script >
  	/*$(document).ready(function () {
        ...
        $("#btn_login").click(function (e) {
            var numbers = $('#username').val();
            var filter = /^([a-z0-9\+_\-]+)(\.[a-z0-9\+_\-]+)*@([a-z0-9\-]+\.)+[a-z]{2,6}$/;
            $abc = $.trim(numbers).match(filter) ? true : "Sai thông tin";
            alert($abc);
            if (!$abc) {
                e.preventDefault();
            }
